const {
  ...
  const sessdata = config.SESSION_ID.replace("rochana~", '');
...
console.log("Session downloaded ✅")
  ...
  ╟─────────────────╢
  ║ ♻ 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐋𝐈𝐍𝐊          
  ║ https://wa.me/94766443560?text=hey%20ROCHANA%20-MD%20whtsapp%20bot%20creater%20💘🫶🏻✨                 
  ╠═════════════════╣
  ║      ROCHANA MD               
  ║ > © ᴘᴏᴡᴇʀᴇᴅ ʙʏ  ʀᴏᴄʜᴀɴᴀ ᴍᴅ      
  ╚═════════════════╝
`;
  conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://files.catbox.moe/543v0x.png` }, caption: up })
